...
// Cập nhật tin nhắn
router.put('/messages/:messageId', authMiddleware_1.protect, ChatController.updateMessage);
// Xóa tin nhắn
router.delete('/messages/:messageId', authMiddleware_1.protect, ChatController.deleteMessage);
